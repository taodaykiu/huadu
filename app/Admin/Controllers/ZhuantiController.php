...
class ZhuantiController extends Controller
{
    ...
    public function getzhauntilevel1(Request $request)
    {
        return Cate::whereType(2)->wherePid(0)->get(['id','name as text']);
    }

    public function getzhauntilevel2(Request $request)
    {
        $q = $request->q;
        return Cate::whereType(2)->wherePid($q)->get(['id','name as text']);
    }
}
